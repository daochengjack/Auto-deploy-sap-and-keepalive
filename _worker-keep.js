// 环境变量配置(必填)
let email = "jack@ceramic.ac.cn";      // SAP登录邮箱,直接填写或设置环境变量，变量名：EMAIL
let password = "S3721668a;";   // SAP登录密码,直接填写或设置环境变量，变量名：PASSWORD
...
const MONITORED_APPS = [ // 格式: {url: "应用URL", name: "应用名称"}
  {url: "https://free-sgcaeejm.cfapps.ap21.hana.ondemand.com/", name: "free-sgcaeejm"},  
];
